...
// all_equal_to
bool all_equal_to(const RObject& x, const RObject& y);
...
// get_splitsC
NumericVector get_splitsC(const NumericVector& x, double caliper);
...
// has_n_unique
bool has_n_unique(SEXP x, int n);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const Nullable<IntegerVector>& >::type strata_(strata_SEXP);
    Rcpp::traits::input_parameter< const bool& >::type local_(local_SEXP);
    rcpp_result_gen = Rcpp::wrap(nn_matchC_distmat_closest(treat, ratio, discarded, reuse_max, distance_mat, exact_, caliper_dist_, caliper_covs_, caliper_covs_mat_, antiexact_covs_, unit_id_, close, disl_prog, strata_, local_));
    return rcpp_result_gen;
END_RCPP
}
// nn_matchC_mahcovs
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const Nullable<IntegerVector> >::type strata_(strata_SEXP);
    Rcpp::traits::input_parameter< const bool >::type local_(local_SEXP);
    rcpp_result_gen = Rcpp::wrap(nn_matchC_mahcovs(treat_, ord, ratio, discarded, reuse_max, focal_, mah_covs, distance_, exact_, caliper_dist_, caliper_covs_, caliper_covs_mat_, antiexact_covs_, unit_id_, disl_prog, strata_, local_));
    return rcpp_result_gen;
END_RCPP
}
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const Nullable<IntegerVector>& >::type strata_(strata_SEXP);
    Rcpp::traits::input_parameter< const bool& >::type local_(local_SEXP);
    rcpp_result_gen = Rcpp::wrap(nn_matchC_mahcovs_closest(treat, ratio, discarded, reuse_max, mah_covs, distance_, exact_, caliper_dist_, caliper_covs_, caliper_covs_mat_, antiexact_covs_, unit_id_, close, disl_prog, strata_, local_));
    return rcpp_result_gen;
END_RCPP
}
// nn_matchC_vec
...
// preprocess_matchC
IntegerVector preprocess_matchC(const IntegerVector& t, const NumericVector& p);
...
// subclass2mmC
IntegerMatrix subclass2mmC(const IntegerVector& subclass_, const IntegerVector& treat, int focal);
...
// subclass_scootC
IntegerVector subclass_scootC(const IntegerVector& subclass_, const IntegerVector& treat_, const NumericVector& x_, int min_n);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_MatchIt_nn_matchC_distmat", (DL_FUNC) &_MatchIt_nn_matchC_distmat, 16},
    {"_MatchIt_nn_matchC_distmat_closest", (DL_FUNC) &_MatchIt_nn_matchC_distmat_closest, 15},
    {"_MatchIt_nn_matchC_mahcovs", (DL_FUNC) &_MatchIt_nn_matchC_mahcovs, 17},
    {"_MatchIt_nn_matchC_mahcovs_closest", (DL_FUNC) &_MatchIt_nn_matchC_mahcovs_closest, 16},
